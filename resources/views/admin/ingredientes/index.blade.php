                    ...
                    @foreach ($ingredientes as $ing)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                <button
                                    @click.prevent="openEdit({{ $ing->id }}, '{{ addslashes($ing->nombre) }}', '{{ $ing->tipo }}', '{{ $ing->costo }}')"
                                    class="text-blue-600 hover:underline focus:outline-none">
                                    Editar
                                </button>
                                <button @click.prevent="openDelete({{ $ing->id }}, '{{ addslashes($ing->nombre) }}')"
            ...
            Alpine.data('ingredienteModal', () => ({
                ...
                openEdit(id, nombre, tipo, costo) {
                    ...
                    this.$nextTick(() => {
                        ...
                        this.$el.querySelector('#tipo').value = tipo;
                        this.$el.querySelector('#costo').value = costo;
                    });
                },
                closeEdit() {
